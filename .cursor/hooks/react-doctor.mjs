...
const runReactDoctor = (outputPath) => {
  ...
  const localBin =
    process.platform === "win32" ? "node_modules\\.bin\\react-doctor.cmd" : "./node_modules/.bin/react-doctor";
  const commands = [
    ...(existsSync(localBin) ? [localBin + " --verbose --scope changed --blocking warning --no-score"] : []),
